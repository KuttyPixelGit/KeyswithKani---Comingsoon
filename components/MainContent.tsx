    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20" onMouseMove={handleMove} onMouseLeave={handleLeave}>
      ...
      <div className="text-center mb-10 w-full max-w-6xl mx-auto px-4">
        ...
        <p className={`text-lg md:text-xl lg:text-2xl font-medium ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
          <span>Contact us at</span>: <a href="mailto:contact@keyswithkani.ca" className={`font-bold ${isDarkMode ? "text-[#FFD700] hover:text-[#00C8C8]" : "text-[#00AAAA] hover:text-[#00C8C8]"}`}>contact@keyswithkani.ca</a>
        </p>
      </div>
      </div>
    </section>
