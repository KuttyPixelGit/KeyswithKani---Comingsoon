...
const LoadingScreen: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-[#F2F2F0] pointer-events-none" style={{ animation: "fadeOutContainer .4s ease-out 1.4s forwards" }}>
      {/* Background effects to match main page */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute -top-36 -left-36 w-80 h-80 rounded-full blur-2xl opacity-30" style={{ backgroundColor: "#00C8C8", transform: translate(6) }} />
        <div className="absolute -bottom-40 -right-32 w-64 h-64 rounded-full blur-2xl opacity-20" style={{ backgroundColor: "#00C8C8", transform: translate(-5) }} />
        <div className="absolute top-1/3 right-1/4 w-56 h-56 rounded-full blur-xl opacity-15" style={{ backgroundColor: "#00C8C8", transform: translate(4) }} />
      </div>
